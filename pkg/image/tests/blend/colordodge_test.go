...
func TestBlendColorDodge(t *testing.T) {
	testCases := []blendTestCase{
		...
		},
		{
			colors: Opaque2,
			compositing: map[op.BlendCompositing]color.NRGBA{
				op.CompositeAll:         c(0xff_aa_ff_ff),
				op.CompositeBlendAndSrc: c(0xff_aa_ff_ff),
				op.CompositeBlendAndDst: c(0xff_aa_ff_ff),
				op.CompositeBlendOnly:   c(0xff_aa_ff_ff),
			},
			tolerance: 1,
		},
		{
		...
		},
		{
			colors: Translucent,
			compositing: map[op.BlendCompositing]color.NRGBA{
				op.CompositeAll:         c(0xaa_79_bf_c0),
				op.CompositeBlendAndSrc: c(0xea_86_d5_80),
				op.CompositeBlendAndDst: c(0xbf_9b_ea_80),
				op.CompositeBlendOnly:   c(0xff_aa_ff_40),
			},
			tolerance: 1,
		},
	}

	runBlendTest(t, "ColorDodge", testCases, nrgba.BlendColorDodge, rgba.BlendColorDodge)
}
