...
func TestBlendLinearLight(t *testing.T) {
	testCases := []blendTestCase{
		...
		},
		{
			colors: Opaque2,
			compositing: map[op.BlendCompositing]color.NRGBA{
				op.CompositeAll:         c(0xc1_01_c1_ff),
				op.CompositeBlendAndSrc: c(0xc1_01_c1_ff),
				op.CompositeBlendAndDst: c(0xc1_01_c1_ff),
				op.CompositeBlendOnly:   c(0xc1_01_c1_ff),
			},
			tolerance: 1,
		},
		{
		...
		},
		{
			colors: Translucent,
			compositing: map[op.BlendCompositing]color.NRGBA{
				op.CompositeAll:         c(0x95_40_aa_c0),
				op.CompositeBlendAndSrc: c(0xc1_17_ab_80),
				op.CompositeBlendAndDst: c(0x96_2c_c1_80),
				op.CompositeBlendOnly:   c(0xc1_01_c1_40),
			},
			tolerance: 1,
		},
	}

	runBlendTest(t, "LinearLight", testCases, nrgba.BlendLinearLight, rgba.BlendLinearLight)
}
