...
func TestCompositeDestination(t *testing.T) {
	testCases := []compositeTestCase{
		...
		{
			colors:    Translucent,
			expected:  c(0x40_80_c0_80),
			tolerance: 0,
		},
	}

	runCompositeTest(t, "Source", testCases, nrgba.CompositeDestination, rgba.CompositeDestination)
}
