...
func TestCompositeDestinationAtop(t *testing.T) {
	...
	runCompositeTest(t, "DestinationAtop", testCases, nrgba.CompositeDestinationAtop, rgba.CompositeDestinationAtop)
}
