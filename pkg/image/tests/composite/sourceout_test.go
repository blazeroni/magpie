...
func TestCompositeSourceOut(t *testing.T) {
	testCases := []compositeTestCase{
		...
		{
			colors:    Translucent,
			expected:  c(0xc0_40_80_3f),
			tolerance: 1,
		},
	}

	runCompositeTest(t, "SourceOut", testCases, nrgba.CompositeSourceOut, rgba.CompositeSourceOut)
}
